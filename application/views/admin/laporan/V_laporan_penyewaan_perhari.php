...
<head>
    <meta charset="UTF-8">
    <title>Laporan Penyewaan Perhari</title>
</head>
                    ...
                    <table style="border-collapse: collapse; width: 90%;" border="0">
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <span style="font-size: 18pt; font-weight: bold; color: black;">Laporan Penyewaan Perhari</span><br>
            ...
            <tr>
                <td align="center">
                    ...
                    <table style="border-collapse: collapse; width: 90%; font-weight: bold;" border="0">
                        <tr>
                            <th colspan="7" style="text-align:left;">Tanggal : <?php echo date("d M Y", strtotime($tanggal)); ?></th>
                        </tr>
                    </table>
                    <br>
                </td>
